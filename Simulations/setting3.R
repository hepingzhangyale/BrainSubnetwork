#!/usr/bin/env Rscript
#SBATCH --mem-per-cpu=2g  --time=3:00:00 --mail-type=ALL --mail-user=yisha.yao@yale.edu

#setting 3
n <- 1500;  d <- 3500;  q <- 700;  p <- 200;  del <- 0.1714
alpha <- 20; opt_lam <- 3000; lam_0 <- 3700;  lam_thred <- 1200 # tuning lam_0, lam_thred, alpha=20
...
save(d, p, q, group_sizes, Beta, Beta_labels, Beta_cluster_num, true_means,
     ...
     file = "/gpfs/gibbs/project/zhang_heping/yy634/cluster_gene_association/submit2/simulation2/setting3_alpha20_lamthred1200.RData")
